package tugas.uas.anggrdh.Adapter;
...
import tugas.uas.anggrdh.Models.Products;
import tugas.uas.anggrdh.ProductInfoActivity;
import tugas.uas.anggrdh.R;
...
public class MyCampaignAdapter extends RecyclerView.Adapter<MyCampaignAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.pdesc.setText("Rp "+productModel.getBid());
                    ...
                    if (snapshot.child("winner").hasChild("uid")){
                        ...
                        reference1.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                                ...
                                holder.bidstatus.setText("Product sold to "+name+" at Rp "+ammount+"\nContact them at - "+email);
                        ...
                        holder.bidstatus.setText("Pelelangan selesai.\nTidak ada yang menawar produk anda");
                    }
                }
