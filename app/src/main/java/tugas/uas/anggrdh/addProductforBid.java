...
import tugas.uas.anggrdh.Adapter.AllImageAdapter;
...
public class addProductforBid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AllImageAdapter(addProductforBid.this,images);
    ...
    private void addProduct() {
        ...
        reference.child(name).setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(addProductforBid.this, "Produk Anda telah ditambahkan untuk lelang", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
